...
### :heavy_exclamation_mark: Для сайта мне пришлось создать [новый репозиторий](https://github.com/harryheman/my-js). Это означает, что данный репозиторий поддерживаться больше не будет (deprecated), новые материалы будут размещаться только на сайте и в новом репозитории.
